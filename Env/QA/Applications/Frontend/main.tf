module "qa_frontend_infra" {
  ...
  template_name                    = local.lt_tags.Name
  tg_name                          = local.tg_tags.Name
  key_name                         = var.key_name
  subnet_id                        = data.terraform_remote_state.network.outputs.subnet_ids.qa-otms-frontend-subnet
  security_group_id                = data.terraform_remote_state.network.outputs.all_sg_ids.frontend
