...
subnet_names = ["public-a", "frontend", "application", "database", "public-b"]
...
nacl_rules = {
  ...
  frontend = {
    subnet_index = [1]
    ingress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "192.168.64.0/28", from_port = 22, to_port = 22 },
      { protocol = "tcp", rule_no = 200, action = "allow", cidr_block = "192.168.64.0/28", from_port = 80, to_port = 80 },
      { protocol = "tcp", rule_no = 300, action = "allow", cidr_block = "192.168.64.48/28", from_port = 80, to_port = 80 },
      { protocol = "tcp", rule_no = 400, action = "allow", cidr_block = "192.168.64.0/28", from_port = 3000, to_port = 3000 },
      { protocol = "tcp", rule_no = 500, action = "allow", cidr_block = "192.168.64.0/28", from_port = 1194, to_port = 1194 },
      { protocol = "tcp", rule_no = 600, action = "allow", cidr_block = "192.168.64.0/28", from_port = 1024, to_port = 65535 }
    ]
    egress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "192.168.64.0/28", from_port = 22, to_port = 22 },
      { protocol = "tcp", rule_no = 200, action = "allow", cidr_block = "192.168.64.0/28", from_port = 1024, to_port = 65535 },
      { protocol = "tcp", rule_no = 300, action = "allow", cidr_block = "192.168.64.32/28", from_port = 8080, to_port = 8080 },
      { protocol = "tcp", rule_no = 400, action = "allow", cidr_block = "192.168.64.0/28", from_port = 1024, to_port = 65535 },
      { protocol = "tcp", rule_no = 500, action = "allow", cidr_block = "192.168.64.0/28", from_port = 1194, to_port = 1194 }
    ]
  }
  ...
  application = {
    ...
    ingress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "192.168.64.0/28", from_port = 22, to_port = 22 },
      { protocol = "tcp", rule_no = 200, action = "allow", cidr_block = "192.168.64.16/28", from_port = 8080, to_port = 8080 },
      { protocol = "tcp", rule_no = 300, action = "allow", cidr_block = "192.168.64.16/28", from_port = 80, to_port = 80 },
      { protocol = "tcp", rule_no = 400, action = "allow", cidr_block = "192.168.64.48/28", from_port = 80, to_port = 80 },
      { protocol = "tcp", rule_no = 500, action = "allow", cidr_block = "192.168.64.0/28", from_port = 1024, to_port = 65535 }
    ]
    egress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "192.168.64.0/28", from_port = 22, to_port = 22 },
      { protocol = "tcp", rule_no = 200, action = "allow", cidr_block = "192.168.64.16/28", from_port = 9042, to_port = 9042 },
      { protocol = "tcp", rule_no = 300, action = "allow", cidr_block = "192.168.64.16/28", from_port = 6379, to_port = 6379 },
      { protocol = "tcp", rule_no = 400, action = "allow", cidr_block = "192.168.64.16/28", from_port = 5432, to_port = 5432 },
      { protocol = "tcp", rule_no = 500, action = "allow", cidr_block = "192.168.64.48/28", from_port = 1024, to_port = 65535 },
      { protocol = "tcp", rule_no = 600, action = "allow", cidr_block = "192.168.64.16/28", from_port = 1024, to_port = 65535 }
    ]
  }
  ...
  database = {
    ...
    ingress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "192.168.64.0/28", from_port = 22, to_port = 22 },
      { protocol = "tcp", rule_no = 200, action = "allow", cidr_block = "192.168.64.32/28", from_port = 9042, to_port = 9042 },
      { protocol = "tcp", rule_no = 300, action = "allow", cidr_block = "192.168.64.32/28", from_port = 6379, to_port = 6379 },
      { protocol = "tcp", rule_no = 400, action = "allow", cidr_block = "192.168.64.32/28", from_port = 5432, to_port = 5432 }
    ]
    egress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "192.168.64.0/28", from_port = 22, to_port = 22 },
      { protocol = "tcp", rule_no = 200, action = "allow", cidr_block = "192.168.64.32/28", from_port = 1024, to_port = 65535 },
      { protocol = "tcp", rule_no = 300, action = "allow", cidr_block = "192.168.64.32/28", from_port = 8080, to_port = 8080 }
    ]
  }
}
